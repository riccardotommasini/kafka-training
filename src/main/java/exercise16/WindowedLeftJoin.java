...
public class WindowedLeftJoin {
    ...
    public static void main(String[] args) {
        ...
        KStream<String, RegionalView> pageviewsbyregion = joined.selectKey((key, value) -> value.getUser_region()).through("pageviewsbyregion", Produced.with(Serdes.String(), new RegionalPageSerde()));
