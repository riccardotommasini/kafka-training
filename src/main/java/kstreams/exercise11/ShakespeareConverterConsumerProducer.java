...
public class ShakespeareConverterConsumerProducer {
            ...
            try (KafkaConsumer<String, String> consumer = new KafkaConsumer<>(props)) {
                ...
                while (true) {
                    ...
                    for (ConsumerRecord<String, String> record : records) {
                        ...
                        PoemKey shakespeareKey = getShakespeareKey(record.key());
                        Poem shakespeareLine = getShakespeareLine(record.value());
     ...
     */
    private PoemKey getShakespeareKey(String key) {
        ...
        return new PoemKey(key, yearWritten);
    }
     ...
     */
    private Poem getShakespeareLine(String line) {
        ...
        if (matcher.matches()) {
            ...
            return new Poem(lineNumber, lineOfWork);
        } else {
