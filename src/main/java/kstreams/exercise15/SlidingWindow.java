package kstreams.exercise15;

import com.google.gson.Gson;
import kstreams.exercise15.model.Order;
...
public class SlidingWindow {
    ...
    public static void main(String[] args) {
        ...
        TimeWindowedKStream<String, Order> windowedKStream = ordersj
                ...
                //sliding window of 10 seconds width and 5 seconds slide
        ...
        ks.allMetadata().forEach(streamsMetadata -> {
