...
public class AvroLocation extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static exercise9.AvroLocation.Builder newBuilder() {
    return new exercise9.AvroLocation.Builder();
  }
   ...
   * @return A new AvroLocation RecordBuilder
   */
  public static exercise9.AvroLocation.Builder newBuilder(exercise9.AvroLocation.Builder other) {
    return new exercise9.AvroLocation.Builder(other);
  }
   ...
   * @return A new AvroLocation RecordBuilder
   */
  public static exercise9.AvroLocation.Builder newBuilder(exercise9.AvroLocation other) {
    return new exercise9.AvroLocation.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroLocation>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(exercise9.AvroLocation.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(exercise9.AvroLocation other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.locationArea)) {
        this.locationArea = data().deepCopy(fields()[0].schema(), other.locationArea);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public exercise9.AvroLocation.Builder setLocationArea(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public exercise9.AvroLocation.Builder clearLocationArea() {
      locationArea = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public exercise9.AvroLocation.Builder clearLocationType() {
      locationType = null;
